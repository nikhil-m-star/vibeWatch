export default function Loading() {
  ...
  return (
    <div className="max-w-7xl mx-auto w-full px-4 md:px-8 py-8 space-y-12 animate-pulse">
      ...
      <div className="w-full h-[220px] rounded-[24px] bg-[#11131a] border border-white/5 flex flex-col justify-center items-center p-8 space-y-4">
          ...
          <div className="flex gap-6 overflow-hidden">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="flex-none w-[180px] md:w-[220px] space-y-3">
                <div className="aspect-[2/3] w-full rounded-[24px] bg-[#11131a] border border-white/5" />
